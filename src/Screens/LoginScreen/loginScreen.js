  ...
  return (
        ...
        <View style={{width:'81%', alignSelf:'center'}}>
         ...
         <TextInputMaterial 
          ...
          <View style={{flex:1}}>
         <Text style={{textAlign:'center',marginTop:-10, color:'white', fontSize:16}}>New Member? <Text onPress={()=>props.navigation.navigate('SignUpScreen')} style={{color:'yellow', fontWeight:'bold'}}>SIGN UP</Text></Text>

          </View>
          <View style={{flex:1}}>
         <Text onPress={()=>props.navigation.navigate('ForgotPasswordScreen')} style={{textAlign:'center', color:'white', fontSize:16}}>Forgot Password</Text>
